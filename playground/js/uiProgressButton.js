		...
		var self = this,
			endLoading = function() {
				...
				if( typeof status === 'number' ) {
					...
					$("button span").addClass("completed-status").text("Completed");
					setTimeout(function() {
						$(".cancel-button").css("display","flex");
						setTimeout(function() {
							$(".cancel-button").addClass("action-clicked");
						},10);
					},500);
					

					// $(".success").click(function() {
					// 	$("button span").removeClass("completed-status").text("Complete").css("margin-left","0");
					// 	classie.remove( self.el, statusClass );
					// 	statusEl.draw(0);
					// 	self._enable();
