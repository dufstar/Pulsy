...
!(function (a) {
  function b(a) {
    ...
    var c = function c(a, b) {
      ...
      } else if (h) for (; g > f && (e = c.call(a[f], f, a[f]), e !== !1); f++);else for (f in a) if ((e = c.call(a[f], f, a[f]), e === !1)) break;return a;
      ...
      var a,
          ...
          i = 1,
          j = arguments.length,
          k = !1;for ("boolean" == typeof h && (k = h, h = arguments[i] || {}, i++), "object" != typeof h && "function" !== c.type(h) && (h = {}), i === j && (h = this, i--); j > i; i++) if (null != (f = arguments[i])) for (e in f) a = h[e], d = f[e], h !== d && (k && d && (c.isPlainObject(d) || (b = c.isArray(d))) ? (b ? (b = !1, g = a && c.isArray(a) ? a : []) : g = a && c.isPlainObject(a) ? a : {}, h[e] = c.extend(k, g, d)) : void 0 !== d && (h[e] = d));return h;
    }, c.queue = function (a, d, e) {
      function f(a, c) {
        var d = c || [];return (null != a && (b(Object(a)) ? !(function (a, b) {
          for (var c = +b.length, d = 0, e = a.length; c > d;) a[e++] = b[d++];if (c !== c) for (; void 0 !== b[d];) a[e++] = b[d++];return (a.length = e, a);
      ...
      c.each(a.nodeType ? [a] : a, function (a, d) {
        ...
        function a() {
          for (var a = this.offsetParent || document; a && "html" === !a.nodeType.toLowerCase && "static" === a.style.position;) a = a.offsetParent;return a || document;
        }var b = this[0],
            a = a.apply(b),
            d = this.offset(),
  ...
  return (function (a, b, c, d) {
    function e(a) {
      ...
      function f(a, b) {
        ...
        var f,
            g,
            h = 0;do g = c + (e - c) / 2, f = i(g, a, d) - b, f > 0 ? e = g : c = g; while (Math.abs(f) > r && ++h < s);return g;
      }function n(b) {
        for (var c = 0, e = 1, f = t - 1; e != f && x[e] <= b; ++e) c += u;--e;var g = (b - x[e]) / (x[e + 1] - x[e]),
            h = c + g * u,
        ...
        y = !0, (a != c || d != e) && l();
          ...
          t = 11,
          u = 1 / (t - 1),
          v = ("Float32Array" in b);if (4 !== arguments.length) return !1;for (var w = 0; 4 > w; ++w) if ("number" != typeof arguments[w] || isNaN(arguments[w]) || !isFinite(arguments[w])) return !1;a = Math.min(a, 1), d = Math.min(d, 1), a = Math.max(a, 0), d = Math.max(d, 0);var x = v ? new Float32Array(t) : new Array(t),
          y = !1,
          z = function z(b) {
      ...
      if (a) {
        var b = new Date().getTime(),
            c = t.State.calls.length;c > 1e4 && (t.State.calls = e(t.State.calls));for (var f = 0; c > f; f++) if (t.State.calls[f]) {
          var h = t.State.calls[f],
            ...
            var w = i[s],
              ...
              }j.visibility !== d && "hidden" !== j.visibility && v.setPropertyValue(y, "visibility", j.visibility);for (var B in w) if ("element" !== B) {
                var C,
                    D = w[B],
      ...
      }t.State.calls[a] = !1;for (var p = 0, q = t.State.calls.length; q > p; p++) if (t.State.calls[p] !== !1) {
        i = !0;break;
      ...
      function a(a) {
        ...
        var f,
            ...
            k = 0,
            l = 1e-4,
            m = .016;for (a = parseFloat(a) || 500, b = parseFloat(b) || 20, e = e || null, i.tension = a, i.friction = b, f = null !== e, f ? (k = d(a, b), g = k / e * m) : g = m;;) if ((h = c(h || i, g), j.push(1 + h.x), k += 16, !(Math.abs(h.x) > l && Math.abs(h.v) > l))) break;return f ? function (a) {
      ...
      t.Easings[b[0]] = i.apply(null, b[1]);
          ...
          9 >= n || t.State.isGingerbread || (v.Lists.transformsBase = v.Lists.transformsBase.concat(v.Lists.transforms3D));for (var a = 0; a < v.Lists.transformsBase.length; a++) !(function () {
        ...
        function h(a, c) {
          ...
          i = 0;
        } else i = a.getAttribute(c);else i = h(a, v.Names.prefixCheck(c)[0]);return (v.Values.isCSSNullValue(i) && (i = 0), t.debug >= 2 && console.log("Get " + c + ": " + i), i);
      ...
      function a() {
        ...
        u ? (q = arguments[0].properties || arguments[0].p, s = arguments[0].options || arguments[0].o) : (q = arguments[n], s = arguments[n + 1]);var x = o.length,
          ...
          var z = n + 1;s = {};for (var A = z; A < arguments.length; A++) p.isArray(arguments[A]) || !/^(fast|normal|slow)$/i.test(arguments[A]) && !/^\d/.test(arguments[A]) ? p.isString(arguments[A]) || p.isArray(arguments[A]) ? s.easing = arguments[A] : p.isFunction(arguments[A]) && (s.complete = arguments[A]) : s.duration = arguments[A];
      ...
      t.Redirects["slide" + b] = function (a, c, e, f, g, h) {
        var i = m.extend({}, c),
          ...
          for (var b in n) a.style[b] = n[b];k && k.call(g, g), h && h.resolver(g);
        }, t(a, l, i);
      };
